        ...
        public static class Modes
        {
            ...
            public static class Combo
            {
                ...
                static Combo()
                {
                    ...
                    _useRSlider = ModesMenu.Add("slideRcombo", new Slider("Enemy healt % to use R", 35));
                }
            ...
            public static class Misc
            {
                ...
                private static readonly Slider _Wdmg;
                ...
                {
                    get { return _Wdmg.CurrentValue; }
                }

                static Misc()
                {
                    // Initialize the menu values
                    ModesMenu.AddGroupLabel("W manager");
                    _Wheal = ModesMenu.Add("W4heal", new Slider("How much player health % to change the W for healing ?", 25));
                    _Wdmg = ModesMenu.Add("W4dmg", new Slider("How much player health % to change the W for damage ?", 75));
                }
