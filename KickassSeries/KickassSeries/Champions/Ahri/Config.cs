...
namespace KickassSeries.Champions.Ahri
{
        ...
        public static class Modes
        {
            ...
            public static class Harass
            {
                ...
                static Harass()
                {
                    ...
                    _Mana = ModesMenu.Add("harassMana", new Slider("Min mana to harass", 30));
                }
            ...
            public static class LaneClear
            {
                ...
                static LaneClear()
                {
                    ...
                    _minQ = ModesMenu.Add("laneQmin", new Slider("Min minions to use Q", 3, 1, 6));
                    _useW = ModesMenu.Add("laneW", new CheckBox("Use W"));
                    _useE = ModesMenu.Add("laneE", new CheckBox("Use E"));
                    _ManaLane = ModesMenu.Add("laneMana", new Slider("Min mana to lane clear", 30));
                }
