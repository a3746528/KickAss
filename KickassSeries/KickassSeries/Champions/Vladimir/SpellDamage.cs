        ...
        public static float GetRealDamage(this SpellSlot slot, Obj_AI_Base target)
        {
            ...
            switch (slot)
            {
                case SpellSlot.Q:
                    ...
                    damage = new float[] {90, 125, 160, 195, 230}[spellLevel] + 0.6f*Player.Instance.FlatMagicDamageMod;
                    break;
                ...
                case SpellSlot.R:
                    ...
                    damage = new float[] {168, 280, 392}[spellLevel] + 0.78f*Player.Instance.FlatMagicDamageMod;
                    break;
            }
